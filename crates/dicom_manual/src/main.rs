...
//     let millis = rng.random::<u32>();
//     let micros = rng.random::<u32>();
//
//     match std::panic::catch_unwind(|| {
...
//         PrimitiveValue::U16(smallvec::smallvec![random(), random(), random()]),
//         PrimitiveValue::I16(smallvec::smallvec![random(), random()]),
//         PrimitiveValue::U32(smallvec::smallvec![random()]),
//         PrimitiveValue::I32(smallvec::smallvec![random(), random()]),
//         PrimitiveValue::U8(random_bytes(rng, 50).into()),
//         PrimitiveValue::F32(smallvec::smallvec![random(), random()]),
//         PrimitiveValue::F64(smallvec::smallvec![random()]),
//     ];
//
...
//     let u32_val = random();
//     let i32_val = random();
//     let large_vec: smallvec::SmallVec<[u16; 2]> = (0..10000).map(|_| random()).collect();
