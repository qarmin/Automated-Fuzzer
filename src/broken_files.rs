...
const SVG_ARGS: &[&str] = &[
    ...
    "id", "class", "style", "transform", "visibility",
    ...
    "gradientUnits", "gradientTransform", "filter", "flood-color", "flood-opacity",
    "from", "to", "dur", "repeatCount", "keyTimes", "keyPoints",
    "href", "xlink:href",
...
const GDSCRIPT_ARGS: &[&str] = &[
    ...
    "enum", "signal", "func", "class_name", "extends", "tool", "var", "setget",
...
pub(crate) fn create_broken_files(obj: &dyn ProgramConfig, lang: LANGS) -> Child {
    ...
    match lang {
        ...
        LANGS::GDSCRIPT => com = com.args(GDSCRIPT_ARGS),
        LANGS::BINARY => {
            com = com.args(
                format!(
